//prevent delete, because I don't have a CDN.  Updated to commit commit 0ebd7764d435ec1d3a9dab5040ec9a6cb4d36afd
(function() {
	Array.prototype.contains = function (e) {
		return this.indexOf(e) > -1
	}

	function PreventDelete(tinymce) {
		var self = this
...
// 	toolbar: 'save,|,undo,redo|,formatselect,|,bold,italic,backcolor,|,bullist,numlist,|',
// 	setup: function(ed) {
